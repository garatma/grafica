class Phong2 {
    ...
    constructor(gl) {
        ...
        this.u_imagen2 = this.gl.getUniformLocation(this.shader_program,'imagen2');
    ...
    fragment(){
        ...
        void main() {
            ...
            vec3 espec = vec3(texture(imagen2,coordenadaTextura));
            ...
            vec3 color = intensidad_ambiente*difusa+fa*intensidad*(difusa*NL + espec*NHn);
